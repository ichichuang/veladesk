...
const zhCNCatalog = {
  ...
  "visualEditor.resizeHint": "应用占用区域请在「整理」模式中调整;图标与标题显示可在此设置。",
  "visualEditor.section.icon": "图标",
  "visualEditor.section.title": "标题",
  "visualEditor.section.appearance": "外观",
  "visualEditor.iconSize": "图标大小",
  "visualEditor.labelVisible": "显示应用名称",
  "visualEditor.labelSize": "标题大小",
...
export const enUS: MessageCatalog = {
  ...
  "visualEditor.resizeHint": "Resize the app tile in Arrange mode. Icon and title appearance are configured here.",
  "visualEditor.section.icon": "Icon",
  "visualEditor.section.title": "Title",
  "visualEditor.section.appearance": "Appearance",
  "visualEditor.iconSize": "Icon size",
  "visualEditor.labelVisible": "Show application name",
  "visualEditor.labelSize": "Title size",
