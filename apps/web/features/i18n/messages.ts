...
const zhCNCatalog = {
  ...
  "visualEditor.tab.uploadLater": "上传图片将在下一阶段提供",
  ...
  "visualEditor.iconSize": "图标大小 {percent}%",
...
export const enUS: MessageCatalog = {
  ...
  "iconPicker.tab.all": "All",
  "iconPicker.tab.brands": "Brands",
  ...
  "visualEditor.tab.uploadLater": "Uploading images arrives in the next phase",
  ...
  "visualEditor.iconSize": "Icon size {percent}%",
